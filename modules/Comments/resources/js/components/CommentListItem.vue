    ...
    >
      <div class="flex flex-wrap" v-show="!commentBeingEdited">
        <div class="grow" v-once>
          ...
          <b style="color: rgb(2, 2, 2); margin-left: 3px;" class="font-medium" v-text="creator.name"></b>
          <b style="color: rgb(8, 8, 8); margin-left: 3px;" class="font-medium" v-text="' Update a Client Feedback. '"></b>
          <b style="color: rgb(13, 127, 226); margin-left: 3px;" class="font-bold" v-text="' *Feedback Type='"></b>
          <b style="color: rgb(255, 0, 0); margin-left: 3px;" class="font-medium" v-text="sentiment"></b>
          <!-- <i18n-t
            scope="global"
